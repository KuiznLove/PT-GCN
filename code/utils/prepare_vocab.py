...
def parse_args():
    ...
    parser.add_argument('--data_dir', default='../../data/ASTE-V2/16res', help='data directory.')
    parser.add_argument('--vocab_dir', default='../../data/ASTE-V2/16res', help='Output vocab directory.')
